...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-slate-700 antialiased leading-relaxed">
      <p className="text-3xl font-bold text-slate-900 mb-2">Privacy Policy</p>
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Account</strong> means a unique
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Cookies</strong> are small files that
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Personal Data</strong> (or
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Service Provider</strong> means any
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Usage Data</strong> refers to data
      ...
      <p className="mb-1 pl-4 text-slate-600">Email address</p>
      <p className="mb-1 pl-4 text-slate-600">First name and last name</p>
      <p className="mb-1 pl-4 text-slate-600">Phone number</p>
      <p className="mb-6 pl-4 text-slate-600">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          <strong className="text-slate-900">Web Beacons.</strong> Certain
      ...
      <p className="mt-4 mb-1 font-semibold text-slate-800">
        Necessary / Essential Cookies
      </p>
      <p className="mb-1 text-sm text-slate-600">Type: Session Cookies</p>
      <p className="mb-1 text-sm text-slate-600">Administered by: Us</p>
      <p className="mb-4">
      ...
      <p className="mb-1 text-sm text-slate-600">Type: Persistent Cookies</p>
      <p className="mb-1 text-sm text-slate-600">Administered by: Us</p>
      <p className="mb-4">
      ...
      <p className="mb-3">
        <strong className="text-slate-900">To manage Your Account:</strong> to
      ...
      <p className="mb-3">
        <strong className="text-slate-900">To contact You:</strong> To contact
      ...
      <p className="mb-3">
        <strong className="text-slate-900">To provide You</strong> with news,
      ...
      <p className="mb-3">
        <strong className="text-slate-900">To manage Your requests:</strong> To
        attend and manage Your requests to Us.
      </p>
      <p className="mb-3">
        <strong className="text-slate-900">For business transfers:</strong> We
        may use Your Personal Data to evaluate or conduct a merger, divestiture,
      ...
      <p className="mb-6">
        <strong className="text-slate-900">For other purposes</strong>: We may
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        <li>
          <strong className="text-slate-900">With Service Providers:</strong> We
          may share Your Personal Data with Service Providers to monitor and
          analyze the use of our Service, to contact You.
        </li>
        <li>
          <strong className="text-slate-900">For business transfers:</strong> We
          may share or transfer Your Personal Data in connection with, or during
          negotiations of, any merger, sale of Company assets, financing, or
          acquisition of all or a portion of Our business to another company.
        </li>
        <li>
          <strong className="text-slate-900">With Affiliates:</strong> We may
          share Your Personal Data with Our affiliates, in which case we will
        ...
        <li>
          <strong className="text-slate-900">With business partners:</strong> We
          may share Your Personal Data with Our business partners to offer You
          certain products, services or promotions.
        </li>
        <li>
          <strong className="text-slate-900">With other users:</strong> If Our
          Service offers public areas, when You share Personal Data or otherwise
          interact in the public areas with other users, such information may be
          viewed by all users and may be publicly distributed outside.
        </li>
        <li>
          <strong className="text-slate-900">With Your consent</strong>: We may
          disclose Your Personal Data for any other purpose with Your consent.
        </li>
      </ul>
      ...
      <p className="mt-4 mb-2 font-semibold text-slate-800">
        Account Information
      </p>
      ...
      <p className="mt-4 mb-2 font-semibold text-slate-800">Usage Data</p>
      <p className="mb-4">
        Website analytics data (cookies, IP addresses, device identifiers): up
        to 24 months from the date of collection, which allows us to analyze
      ...
      <p className="mt-4 mb-1 font-semibold text-slate-800">Mouseflow</p>
      <p className="mb-2">
        Mouseflow is a session replay and heatmap tool that shows how visitors
        click, move, scroll, browse, and pay attention on websites. The service
        is operated by ApS.
      </p>
      <p className="mb-2">
      ...
      <p className="mt-4 mb-1 font-semibold text-slate-800">FreshDesk</p>
      <p className="mb-2">
      ...
      <p className="mt-4 mb-1 font-semibold text-slate-800">Google Places</p>
      <p className="mb-2">
