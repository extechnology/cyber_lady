...
export default function TermsAndConditions() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 text-slate-700 antialiased leading-relaxed">
      <p className="text-3xl font-bold text-slate-900 mb-2">
        Terms and Conditions
      </p>
      <p className="text-sm text-slate-500 mb-6">Last updated: June 22, 2026</p>
      ...
      <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4 border-b pb-2">
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Affiliate</strong> means an entity
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Country</strong> refers to: Kerala,
        India
      </p>
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Device</strong> means any device that
        can access the Service such as a computer, a cell phone or a digital
        tablet.
      </p>

      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Service</strong> refers to the
        Website.
      </p>

      <p className="mb-6 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Terms and Conditions</strong> (also
        referred to as &quot;Terms&quot;) means these Terms and Conditions,
        including any documents expressly incorporated by reference, which
        govern Your access to and use of the Service and form the entire
      ...
      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        ...
        services) provided by a third party that is displayed, included, made
        available, or linked to through the Service.
      </p>

      <p className="mb-3 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">Website</strong> refers to
        www.cyberlady.in, accessible from{" "}
        <a
          href="http://cyberlady.in/"
      ...
      <p className="mb-6 pl-4 border-l-2 border-slate-200">
        <strong className="text-slate-900">You</strong> means the individual
      ...
      <p className="mb-4">
        ...
        the agreement between You and the Company. These Terms and Conditions
      ...
      <p className="mb-6">
        ...
        to be caused by or in connection with Your access to or use of any
        Third-Party Social Media Service, including any content, goods, or
        services made available through them. Your use of any Third-Party Social
        Media Service is governed by that Third-Party Social Media Service's
      ...
      <h3 className="text-xl font-semibold text-slate-800 mt-6 mb-3">Waiver</h3>
      <p className="mb-6">
